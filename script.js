...
const productSpecificationTables = {
  ...
  "high-pressure-air": [
    {
      ...
      "rows": [
        [
          ...
          "Working Pressure at 30°C kg/cm ²",
          "Standard Length mtrs."
        ],
        [
          "5",
          "2.35",
  ...
  "spray-car-wash": [
    ...
    {
      "title": "High Pressure Car Washing Hose",
      "rows": [
        [
          "Size (mm)",
          "Wall Thickness (mm)",
    ...
    },
    {
      ...
      "rows": [
        [
          ...
          "I.D (mm)",
          "O.D (mm)",
          "Bursting Pressure at 30°C kg/cm²",
          "Standard Length (mtrs.)"
        ],
        [
          "8.5",
  ...
  "pu-hose": [
    ...
    {
      "title": "PU Extra Heavy Duct Hose",
      "rows": [
        [
          "Size (Inch)",
          "ID (mm)",
  ...
  "upvc-agriculture": [
    {
      ...
      "rows": [
        [
          "IS 4985 : 2000 (Extract)",
          "Wall Thickness for working pressure classes (mm)"
        ],
        [
          "Outside diameter (mm)",
          "Tolerance on outside diameter (mm)",
          "Class 1 2.5 kg/cm²",
          "Class 2 4 kg/cm²",
          "Class 3 6 kg/cm²",
          "Class 5 10 kg/cm²",
  ...
  "submersible-column": [
    {
      "title": "Dimensional Specification - Bell Type",
      "rows": [
        [
          "Dimensional Specification (Bell Type)"
        ],
        [
          "Size",
          "Class",
    ...
    {
      "title": "Dimensional Specification - Coupler Type",
      "rows": [
        [
  ...
  "swr": [
    {
      ...
      "rows": [
        [
          "Size (mm)",
          "O.D (mm)",
          "Wall Thickness (Type A) in mm",
          "Wall Thickness (Type B) in mm"
        ],
        [
          "Min.",
          "Max.",
  ...
  "hdpe-pipes": [
    {
      "title": "PE 63 pipes - wall thickness by pressure rating",
      "rows": [
        [
          "(All Dimensions in mm) Wall Thickness of pipes for Pressure Rating of"
        ],
        [
          "O.D",
          "PN 2.5",
    ...
    {
      "title": "PE 80 pipes - wall thickness by pressure rating",
      "rows": [
        [
          "(All Dimensions in mm) Wall Thickness of pipes for Pressure Rating of"
        ],
    ...
    {
      "title": "PE 100 pipes - wall thickness by pressure rating",
      "rows": [
        [
          "(All Dimensions in mm) Wall Thickness of pipes for Pressure Rating of"
        ],
    ...
    {
      "title": "MDPE pipes - wall thickness by pressure rating",
      "rows": [
        [
          "(All Dimensions in mm) Wall Thickness of pipes for Pressure Rating of"
        ],
    ...
    {
      "title": "PP pipes - wall thickness by pressure rating",
      "rows": [
        [
          "(All Dimensions in mm) Wall Thickness of pipes for Pressure Rating of"
        ],
    ...
    {
      "title": "PE 100 SDR wall-thickness reference",
      "rows": [
        [
          "(All Dimensions in mm) Wall Thickness of pipes for Pressure Rating of"
        ],
  ...
  "cpvc": [
    {
      "title": "CPVC SDR 11 / SDR 13.5 Pipes",
      "rows": [
        [
          "Nominal Pipe Size",
    ...
    {
      "title": "CPVC Schedule 40 / Schedule 80 Pipes",
      "rows": [
        [
          "Size mm (inch)",
          "Outer Diameter in (mm)",
          "Schedule 40 Wall Thickness in (mm)",
          "Schedule 80 Wall Thickness in (mm)"
        ],
        [
          "65 (2.1/2”)",
          "73.0 ± 0.18 (72.82 – 73.18)",
          "5.16 – 5.77",
          "7.01 – 7.85"
        ],
        [
        ...
        [
          "100 (4”)",
          "114.3 ± 0.23 (114.07 – 114.53)",
          "6.02 – 6.73",
          "8.56 – 9.58"
        ],
        [
          "150 (6”)",
          "168.3 ± 0.28 (168.02 – 168.58)",
          "7.11 – 7.97",
          "10.97 – 12.29"
        ]
      ]
...
const languageCopy = {
  ...
  hi: {
    ...
    "nav.contact": "संपर्क",
    "hero.title": "Dutron के भरोसेमंद flexible पाइप",
    ...
    "footer.copy": "इंडस्ट्रियल सेल्स कॉर्पोरेशन एक स्वतंत्र regional distributor/trader है। Dutron product category और specification references ग्राहकों की जानकारी के लिए Dutron India से लिए गए हैं।",
    "footer.backToTop": "ऊपर जाएं",
    "card.viewDetails": "जानकारी देखें",
    "card.requestQuote": "कोटेशन मांगें",
    "card.empty": "कोई matching उत्पाद नहीं मिला। दूसरी search करें या filter हटाएं।",
    "modal.specifications": "तकनीकी विवरण",
    "modal.details": "जानकारी",
    "modal.applications": "उपयोग",
    "modal.requestQuote": "इस उत्पाद का कोटेशन मांगें",
...
const productTranslations = {
  "md-green": {
    ...
    details: [
      "मजबूती और flexibility देने के लिए rigid PVC के hard spirals soft PVC wall में लगाए जाते हैं।",
  ...
  "high-pressure-air": {
    ...
    details: [
      ...
      "Duplon pressure capacity और flexibility देने के लिए soft PVC की layers के बीच synthetic-yarn braiding use करता है।",
...
const termTranslations = {
  "Sizes": "आकार",
  "Working pressure": "वर्किंग प्रेशर",
  "Bursting pressure": "बर्स्ट प्रेशर",
  "Colour": "रंग",
...
document.addEventListener("click", (event) => {
  ...
  if (quoteButton) {
    ...
    requestQuote(quoteButton.dataset.product);
    return;
  }

  const catalogCard = event.target.closest("[data-product-id]");
  if (catalogCard) {
    const product = products.find((item) => item.id === catalogCard.dataset.productId);
    if (product) openProductDetail(product);
  }
});
...
document.addEventListener("keydown", (event) => {
  const catalogCard = event.target.closest("[data-product-id]");
  if (!catalogCard || (event.key !== "Enter" && event.key !== " ")) return;
